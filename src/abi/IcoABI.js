export const IcoABI = [
  ...
  {
    inputs: [
      { internalType: "uint256", name: "minBuyUsd", type: "uint256" },
      { internalType: "uint256", name: "totalSaleValueUsd", type: "uint256" },
    ],
    name: "MinBuyExceedsTotalSaleValue",
    type: "error",
  },
  {
    inputs: [
  ...
  { inputs: [], name: "SaleNotEnded", type: "error" },
  {
    inputs: [
      {
        internalType: "enum INABICO.Status",
        name: "currentStatus",
        type: "uint8",
      },
    ],
  ...
  },
  {
    inputs: [
      {
        internalType: "enum INABICO.SaleType",
        name: "saleType",
        type: "uint8",
      },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "maxBounceInPercent_", type: "uint256" },
      {
        internalType: "uint256",
        name: "decreseBouncePerDayInPercent_",
        type: "uint256",
      },
      {
        internalType: "uint256",
        name: "minBuyToGetBounceInUsd_",
        type: "uint256",
      },
      { internalType: "uint256", name: "minBuyInUsd_", type: "uint256" },
    ...
    outputs: [
      {
        ...
        internalType: "struct INABICO.PaymentOption",
        name: "",
        type: "tuple",
      },
    ],
  ...
  {
    inputs: [
      { internalType: "address", name: "nabSaleToken_", type: "address" },
      {
        internalType: "address",
        name: "nabReferralContract_",
        type: "address",
      },
    ],
    name: "initialize",
  ...
  {
    inputs: [],
    name: "nabReferralContract",
    outputs: [
      { internalType: "contract INABReferral", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
    ...
    outputs: [
      {
        components: [
          ...
          {
            internalType: "uint256",
            name: "maxBounceInPercent",
            type: "uint256",
          },
          {
            internalType: "uint256",
            name: "decreseBouncePerDayInPercent",
            type: "uint256",
          },
          ...
          {
            internalType: "uint256",
            name: "minBuyToGetBounceInUsd",
            type: "uint256",
          },
          { internalType: "uint256", name: "minBuyInUsd", type: "uint256" },
        ...
        internalType: "struct INABICO.ICO",
        name: "",
        type: "tuple",
      },
    ],
  ...
  },
  {
    ...
    name: "updatenabReferralContract",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
    ...
    outputs: [
      {
        ...
        internalType: "struct INABICO.Claimable",
        name: "",
        type: "tuple",
      },
    ],
    ...
    outputs: [
      {
        ...
        internalType: "struct INABICO.Contributor",
        name: "",
        type: "tuple",
      },
    ],

...
export default function Disclaimer() {
  return (
    <>
      <Head>
        <title>Disclaimer - EpochEra Platform</title>
        <meta name="description" content="Disclaimer for EpochEra platform and Epoch tokens" />
      </Head>
            ...
            <div className="bg-zinc-900/50 rounded-lg border border-zinc-800 p-6 sm:p-8 md:p-12">
              ...
              <div className="space-y-6 text-gray-400 leading-relaxed">
                ...
                <div>
                  ...
                  <p className="text-sm">The regulatory framework governing cryptocurrencies, initial coin offerings (ICOs), token presales, and digital assets is evolving rapidly across global jurisdictions. Future regulatory actions, laws, or enforcement measures may restrict, alter, or prohibit the operational capacity of the EpochEra ecosystem or reduce the utility of Epoch tokens.</p>
                </div>
